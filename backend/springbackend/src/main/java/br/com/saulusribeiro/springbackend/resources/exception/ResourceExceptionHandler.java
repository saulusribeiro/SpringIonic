...
import br.com.saulusribeiro.springbackend.services.exceptions.FileException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> objectNotFound(ObjectNotFoundException e, HttpServletRequest request) {
		...
		StandardError err = new 
				StandardError(System.currentTimeMillis(), HttpStatus.NOT_FOUND.value(),
	...
	public ResponseEntity<StandardError> amazonService(AmazonServiceException e, HttpServletRequest request) {
		...
		StandardError err = new StandardError(System.currentTimeMillis(), code.value(), "Erro no Serviço Amazon", e.getMessage(), request.getRequestURI());
